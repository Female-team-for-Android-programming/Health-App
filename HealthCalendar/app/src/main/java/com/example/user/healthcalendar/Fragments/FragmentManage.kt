 ...
 * [FragmentManage.OnFragmentInteractionListener] interface
...
class FragmentManage : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater?, container: ViewGroup?,
        ...
        val fab : FloatingActionButton = view.findViewById(R.id.fab_manage)
        fab.setOnClickListener(View.OnClickListener {
            Toast.makeText(activity.applicationContext, "Action for Manage Fragment", Toast.LENGTH_SHORT).show()
        })
    ...
    companion object {
        ...
        fun newInstance(param1: String, param2: String): FragmentManage {
